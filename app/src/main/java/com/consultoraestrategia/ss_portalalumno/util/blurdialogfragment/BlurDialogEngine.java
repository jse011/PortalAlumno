package com.consultoraestrategia.ss_portalalumno.util.blurdialogfragment;
...
public class BlurDialogEngine {
    ...
    public BlurDialogEngine(Activity holdingActivity) {
        ...
        //blur_dialog_animation_duration : 300
    ...
    private void blur(Bitmap bkg, View view) {
        ...
        //R.bool.blur_dialog_has_bottom_navigation_bar : true
        //mHoldingActivity.getResources().getBoolean(R.bool.blur_dialog_has_bottom_navigation_bar)
        if (true) {
