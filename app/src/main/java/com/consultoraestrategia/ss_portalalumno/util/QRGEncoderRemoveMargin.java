...
public class QRGEncoderRemoveMargin  {
    //Solo se agrego  hints.put(EncodeHintType.MARGIN, marginSize); al metodo GetBitmap para borrar el margin
    ...
    public QRGEncoderRemoveMargin(String data, String type) {
        encoded = encodeContents(data, null, QRGContents.Type.TEXT);
    }

    public QRGEncoderRemoveMargin(String data, String type, int dimension) {
        this.dimension = dimension;
        encoded = encodeContents(data, null, QRGContents.Type.TEXT);
    }

    public QRGEncoderRemoveMargin(String data, Bundle bundle, String type, int dimension) {
        this.dimension = dimension;
    ...
    public void getBitmap(CalbackBitmap calback) {

    }

    public interface  CalbackBitmap{
