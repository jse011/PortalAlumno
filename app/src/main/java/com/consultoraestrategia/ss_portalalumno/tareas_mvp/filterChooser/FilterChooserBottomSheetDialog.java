package com.consultoraestrategia.ss_portalalumno.tareas_mvp.filterChooser;
...
public class FilterChooserBottomSheetDialog extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if(context instanceof CallbackFilterChooserBottomDialog){
            this.callbackFilter = (CallbackFilterChooserBottomDialog)context;
        }
    }
