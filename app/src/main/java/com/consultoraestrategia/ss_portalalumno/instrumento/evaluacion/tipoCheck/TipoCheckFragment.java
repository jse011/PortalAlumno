package com.consultoraestrategia.ss_portalalumno.instrumento.evaluacion.tipoCheck;
...
import com.consultoraestrategia.ss_portalalumno.instrumento.evaluacion.tipoCheck.adapter.TipoCkeckAdapter;
...
public class TipoCheckFragment extends Fragment implements TipoEvaluacionView, TipoCkeckAdapter.Listener {
    ...
    private TipoCkeckAdapter adapter;
    ...
    private void setupAdater() {
        ...
        adapter = new TipoCkeckAdapter(this);
    ...
    @Override
    public void onClickValorCheck(ValorUi valorUi) {
